...
pub struct ProcessData {
    ...
    pub transport_info: clap_event_transport,
...
pub struct OutOfPlaceAudioBuffers {
    ...
    pub inputs: Box<Vec<Vec<Vec<f32>>>>,
    pub outputs: Box<Vec<Vec<Vec<f32>>>>,
...
unsafe impl Sync for OutOfPlaceAudioBuffers {}
...
impl ProcessData {
    ...
    pub fn new(buffers: AudioBuffers, config: ProcessConfig) -> Self {
        ProcessData {
            buffers,
    ...
    /// Get current the transport information.
    #[allow(unused)]
    pub fn transport_info_mut(&mut self) -> &mut clap_event_transport {
    ...
    pub fn buffers_mut(&mut self) -> &mut AudioBuffers {
        &mut self.buffers
    }
}
...
impl AudioBuffers {
    ...
    /// Get a reference to the buffer's inputs.
    pub fn inputs_mut_ref(&mut self) -> &mut [Vec<Vec<f32>>] {
        match self {
            AudioBuffers::OutOfPlace(buffers) => &mut buffers.inputs,
        }
    }
...
impl OutOfPlaceAudioBuffers {
    ...
    pub fn new(inputs: Box<Vec<Vec<Vec<f32>>>>, outputs: Box<Vec<Vec<Vec<f32>>>>) -> Result<Self> {
